...
<head>
  ...
  <meta name="description" content="Aplikasi Antrian BNNK Magelang">
  <meta name="author" content="Indra Styawantoro">

  <!-- Title -->
  <title>Aplikasi Antrian BNNK Magelang</title>

  <!-- bnn icon -->
  <link rel="shortcut icon" href="assets/img/bnn.png" type="image/x-icon">
  ...
  <main class="flex-shrink-0">
    <div class="container pt-5">
      ...
      <div class="alert alert-light d-flex align-items-center mb-5" role="alert">
        ...
        <div>
          Selamat Datang di <strong>Aplikasi Antrian BNNK Magelang</strong>. Silahkan pilih halaman yang ingin ditampilkan.
        </div>
      </div>
  ...
  <footer class="footer mt-auto py-4">
    <div class="container-fluid">
      ...
      <div class="copyright text-center mb-2 mb-md-0">
        &copy; 2023 - <a href="#" target="_blank" class="text-danger text-decoration-none">BNNK MAGELANG</a>. All rights reserved.
      </div>
    </div>
  </footer>
